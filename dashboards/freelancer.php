...
<div class="dashboard-container">
    <div class="sidebar">
        ...
        <ul>
            ...
            <li data-target="gigs">My Gigs</li>
            <li data-target="projects">Find Projects</li>
            <li data-target="orders">Orders</li>
            <li data-target="messages">Messages <?php if($unread_count > 0): ?><span class="msg-badge"><?php echo $unread_count; ?></span><?php endif; ?></li>
            <li data-target="earnings">Earnings</li>
            <li data-target="profile">Profile Settings</li>
            <li><a href="../auth/logout.php" style="color:#ff0000;">Logout</a></li>
        </ul>
    </div>
            <!-- MAIN CONTENT -->
        <div class="main">
            ...
            <div class="topbar">
                ...
                <div id="overview" class="section active">
                    <?php include('freelancer/overview.php');?>
                </div>
                <div id="gigs" class="section">
                    <?php include('freelancer/gigs.php');?>
                </div>
                <div id="projects" class="section">
                    <?php include('freelancer/projects.php');?>
                </div>
                <div id="orders" class="section">
                    <?php include('freelancer/orders.php');?>
                </div>
                <div id="messages" class="section">
                    <?php include('freelancer/messages.php');?>
                </div>
                <div id="earnings" class="section">
                    <?php include('freelancer/earnings.php');?>
                </div>
                <div id="profile" class="section">
                    <?php include('freelancer/profile.php');?>
                </div>
    </div>
</div>
<script>
