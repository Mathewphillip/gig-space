...
// fetch conversations involving this user (as freelancer) - support project orders
$convo_query = "
    SELECT 
        conversations.id,
        ...
        <div class="conversations">
            ...
            <?php if(mysqli_num_rows($convo_result) > 0): ?>
                ...
                <?php while($convo = mysqli_fetch_assoc($convo_result)): ?>
                    ...
                    <a href="javascript:void(0);" class="conversation-item" data-id="<?php echo $convo['id']; ?>" onclick="loadConversation(<?php echo $convo['id']; ?>, '<?php echo htmlspecialchars($convo['convo_title'], ENT_QUOTES); ?>')">
                        ...
                        <div>
                            <p><?php echo htmlspecialchars($convo['convo_title']); ?></p>
                        </div>
            ...
            <?php else: ?>
                ...
                <div style="padding: 20px; text-align: center; color: #666;">
                    ...
                    <p style="font-size: 14px; margin-bottom: 10px;">No conversations yet. Accept a bid or receive an order.</p>
